...
public class GooPlayerListener extends PlayerListener{

   public static PortalGoo plugin;

   public GooPlayerListener(PortalGoo instance){
      plugin = instance;
   }
   ...
   public void onPlayerMove(PlayerMoveEvent event){
      ...
      // Blue wool
      else if(block.getType().compareTo(Material.WOOL) == 0 && block.getData() == 11){
         float fall;
